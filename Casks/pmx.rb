...
cask "pmx" do
  ...
  on_macos do
    on_arm do
      sha256 "3b2ff41545198e2edcee5d6d5050ba8a437d617ddcb3be5ce27c760bd1ec1cbd"
  ...
  on_linux do
    on_intel do
      sha256 "d56366687d777aa9e1b5038e667f6dd960ca60c0267503f6e0841ae994e8654d"
      url "https://github.com/fivetwenty-io/proxmox-cli/releases/download/v#{version}/pmx_#{version}_linux_amd64.tar.gz"
    end
    on_arm do
      sha256 "ecb859428908cb1f60b7debf6254ddbe0199c19901a0b5cd935bb3403021c0d7"
