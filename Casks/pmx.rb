...
cask "pmx" do
  ...
  on_macos do
    on_arm do
      sha256 "3613086054e87a0645fc6af5cdfdeb8729d8cb560fbf75a750606e07cf1d4856"
  ...
  on_linux do
    on_intel do
      sha256 "a4591cb02f622da3193be945bbbf84e7f94ce000bbc2d3c4d2fd5fb0c3e2fd4b"
      url "https://github.com/fivetwenty-io/proxmox-cli/releases/download/v#{version}/pmx_#{version}_linux_amd64.tar.gz"
    end
    on_arm do
      sha256 "a8f313c219ba5e94331d91326653c967b00edd8d8a619d1e095a00a648af4fb1"
